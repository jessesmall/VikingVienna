...
public class PlayerBounds : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (Below != BoundsBehavior.Nothing && transform.position.y + colliderSize.y < Bounds.bounds.min.y)
            ApplyBoundsBehavior(Below, new Vector2(transform.position.y, Bounds.bounds.min.y + colliderSize.y));
    ...
    private void ApplyBoundsBehavior(BoundsBehavior behavior, Vector2 constrainedPostion)
    {
        ...
        transform.position = constrainedPostion;
    }
